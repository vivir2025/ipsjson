...
<body>
    <div class="container mt-5">
        ...
        <form action="<?php echo site_url('reportes/generar_pdf'); ?>" method="post" id="form_reporte">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Validar documentos
            $('#btn_validar, #documentos_pacientes').on('click blur', function() {
            ...
            function validarDocumentos(documentos) {
                ...
                $.ajax({
                    url: '<?php echo site_url("reportes/validar_documentos"); ?>',
                    type: 'POST',
                        ...
                        if (response.success) {
                            ...
                            if (response.pacientes_encontrados.length > 0) {
                                ...
                                response.pacientes_encontrados.forEach(function(paciente) {
                                    html += `<small class="d-block text-success">• ${paciente.pacDocumento}: ${paciente.pacNombre} ${paciente.pacApellido}</small>`;
                                });
                            }
                    ...
                    error: function() {
                        $('#validacion_documentos').html(`
                            <div class="text-center text-danger">
                                ...
                                <p>Error al validar documentos</p>
                            </div>
                        `);
                    }
                });
