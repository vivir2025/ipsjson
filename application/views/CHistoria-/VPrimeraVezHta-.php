...
<div class="bg-white">
                            ...
                            <table class="table table-bordered" id="data">
                                ...
                                <tbody>
                                    ...
                                    foreach ($medicamento_historia as $mh) {
                                        ...
                                        echo "<td><button type='button' class='btn btn-outline-primary btn-view-medicamento' value='$mh->id_his_med' data-toggle='modal' data-target='#modal_medicamento'>Editar</button>";


                                        echo "<td><a class='btn btn-outline-danger' onclick='eliminar(\"{$mh->id_his_med}\")'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </tbody>
                            ...
                            <table class="table table-bordered" id="data1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($remision_historia as $r) {
                                        ...
                                        echo "<td><a class='btn btn-outline-danger' onclick='eliminar_remision(\"{$r->id_his_rem}\")'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                ...
                                <tr>
                                    <form>
                                        <td>
                                            ...
                                            <input type="text" id="cup" name="cup" onKeyUp="buscar_cups();" class="form-control" placeholder="Ayuda Diagnostico" />
                            ...
                            <table class="table table-bordered" id="data2">
                                ...
                                <tbody>
                                    ...
                                    foreach ($cups_historia as $ch) {
                                        ...
                                        echo "<td><a class='btn btn-outline-danger' onclick='eliminar_cups(\"{$ch->id_his_cups}\")'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($diagnostico_historia as $dh) {
                                    ...
                                    echo "<td><a class='btn btn-outline-danger' onclick='eliminar_diagnostico(\"{$dh->id_his_dia}\")'>Eliminar</a></td>";
                                    echo "</tr>";
                                }
    ...
    <script type="text/javascript">
        ...
        function eliminar_diagnostico(id_his_dia) {
            if (confirm('¿Desea eliminar el diagnostico?')) {

                $.ajax({
                    url: "<?php echo base_url() . 'index.php/CHistoria/eliminar_diagnostico'; ?>",
                    type: 'POST',
                    data: {
                        id_his_dia: id_his_dia
                    },
                    success: function(result) {
