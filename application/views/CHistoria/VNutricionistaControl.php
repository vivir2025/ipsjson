...
<div class="mx-auto" style="width: 1300px;">
    <h5 style="color: blue;">HISTORIA CLÍNICA NUTRICIONISTA CONTROL PROGRAMA DE GESTIÓN DEL RIESGO CARDIORENAL- <?= $detalles_cita[0]->citFecha ?></h5>
            ...
            <div style="margin: 10px;">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="enfermedad_diagnostica" rows="2" required="" placeholder="Enfermedad(es) diagnosticada(s)" id="enfermedad_diagnostica"></textarea>
                    </div>
                </div>
            </div>
        </fieldset><br>
        ...
        <div style="border: ridge #0f0fef 1px;">
            <div class="form-row" style="margin: 10px;">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="Comida_desayuno" id="Comida_desayuno" class="form-control" required="" placeholder="Tiempo de comida desayuno">
                </div>
                <div class="form-group col-md-6">
                    <strong>TIEMPO DE COMIDA 1/2 DESAYUNO</strong>
                    <input type="text" name="Comidamedio_desayuno" id="Comidamedio_desayuno" class="form-control" required="" placeholder="Tiempo de comida 1/2 desayuno">
                </div>
                <div class="form-group col-md-6">
                    <strong>TIEMPO DE COMIDA ALMUERZO</strong>
                    <input type="text" name="Comida_almuerzo" id="Comida_almuerzo" class="form-control" required="" placeholder="Tiempo de comida tarde">
                </div>
                <div class="form-group col-md-6">
                    <strong>TIEMPO DE COMIDA 1/2 TARDE</strong>
                    <input type="text" name="Comidamedio_almuerzo" id="Comidamedio_almuerzo" class="form-control" required="" placeholder="Tiempo de comida 1/2 tarde">
                </div>
                <div class="form-group col-md-6">
                    <strong>TIEMPO DE COMIDA CENA</strong>
                    <input type="text" name="Comida_cena" id="Comida_cena" class="form-control" required="" placeholder="Tiempo de comida cena">
                </div>
            </div>
        </div><br>
        ...
        <div style="border: ridge #0f0fef 1px;">
            <div class="form-row" style="margin: 10px;">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="Lacteo" id="Lacteo" class="form-control" required="" placeholder="Lacteo">
                </div>
                <div class="form-group col-md-6">
                    <strong>LÁCTEO, OBSERVACIÓN</strong>
                    <input type="text" name="Lacteo_observacion" id="Lacteo_observacion" class="form-control" required="" placeholder="Lacteo observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>HUEVO</strong>
                    <input type="text" name="Huevo" id="Huevo" class="form-control" required="" placeholder="Huevo">
                </div>
                <div class="form-group col-md-6">
                    <strong>HUEVO OBSERVACIÓN</strong>
                    <input type="text" name="Huevo_observacion" id="Huevo_observacion" class="form-control" required="" placeholder="Huevo observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>EMBUTIDO</strong>
                    <input type="text" name="Embutido" id="Embutido" class="form-control" required="" placeholder="Embutido">
                </div>
                <div class="form-group col-md-6">
                    <strong>OBSERVACIÓN EMBUTIDO</strong>
                    <input type="text" name="Embutido_observacion" id="Embutido_observacion" class="form-control" required="" placeholder="Observacion embutido">
                </div>
                <div class="form-group col-md-6">
                    <strong>CARNE ROJA</strong>
                    <input type="text" name="Carneroja" id="Carneroja" class="form-control" required="" placeholder="Carne roja">
                </div>
                <div class="form-group col-md-6">
                    <strong>CARNE BLANCA</strong>
                    <input type="text" name="Carneblanca" id="Carneblanca" class="form-control" required="" placeholder="Carne blanca">
                </div>
                <div class="form-group col-md-6">
                    <strong>CARNE VICERA</strong>
                    <input type="text" name="Carnevicera" id="Carnevicera" class="form-control" required="" placeholder="Carne vicera">
                </div>
                <div class="form-group col-md-6">
                    <strong>CARNE OBSERVACIÓN</strong>
                    <input type="text" name="Carneobservacion" id="Carneobservacion" class="form-control" required="" placeholder="Carne observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>LEGUMINOSAS SECAS</strong>
                    <input type="text" name="Leguminosas" id="Leguminosas" class="form-control" required="" placeholder="Leguminosas secas">
                </div>
                <div class="form-group col-md-6">
                    <strong>LEGUMINOSAS SECAS OBSERVACIÓN</strong>
                    <input type="text" name="Leguminosasobservacion" id="Leguminosasobservacion" class="form-control" required="" placeholder="Leguminosas secas observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>FRUTAS EN JUGO</strong>
                    <input type="text" name="Frutas_jugo" id="Frutas_jugo" class="form-control" required="" placeholder="Frutas en jugo">
                </div>
                <div class="form-group col-md-6">
                    <strong>FRUTAS EN PORCIÓN</strong>
                    <input type="text" name="Frutas_porcion" id="Frutas_porcion" class="form-control" required="" placeholder="Frutas en porcion">
                </div>
                <div class="form-group col-md-6">
                    <strong>FRUTAS OBSERVACIÓN</strong>
                    <input type="text" name="Frutas_observacion" id="Frutas_observacion" class="form-control" required="" placeholder="Frutas observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>VERDURAS Y HORTALIZAS</strong>
                    <input type="text" name="Verduras_hortalizas" id="Verduras_hortalizas" class="form-control" required="" placeholder="Verduras y hortalizas">
                </div>
                <div class="form-group col-md-6">
                    <strong>VERDURAS Y HORTALIZAS OBSERVACIÓN</strong>
                    <input type="text" name="Vh_observacion" id="Vh_observacion" class="form-control" required="" placeholder="Verduras y hortalizas observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>CEREALES</strong>
                    <input type="text" name="Cereales" id="Cereales" class="form-control" required="" placeholder="Cereales">
                </div>
                <div class="form-group col-md-6">
                    <strong>CEREALES, OBSERVACIÓN</strong>
                    <input type="text" name="Cereales_observacion" id="Cereales_observacion" class="form-control" required="" placeholder="Cereales observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>RTP</strong>
                    <input type="text" name="RTP" id="RTP" class="form-control" required="" placeholder="RTP">
                </div>
                <div class="form-group col-md-6">
                    <strong>RTP OBSERVACIÓN</strong>
                    <input type="text" name="RTP_observacion" id="RTP_observacion" class="form-control" required="" placeholder="RTP observacion">
                </div>
                <div class="form-group col-md-6">
                    <strong>AZÚCARES Y DULCES</strong>
                    <input type="text" name="Azucar_dulce" id="Azucar_dulce" class="form-control" required="" placeholder="Azucares y dulces">
                </div>
                <div class="form-group col-md-6">
                    <strong>AZÚCARES Y DULCES OBSERVACIÓN</strong>
                    <input type="text" name="Ad_observacion" id="Ad_observacion" class="form-control" required="" placeholder="Azucares y dulces observacion">
                </div>
            </div>
        </div><br>
        ...
        <div style="border: ridge #0f0fef 1px;">
            <div class="form-row" style="margin: 10px;">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="Diagnostico_nutri" rows="2" required="" placeholder="Diagnostico nutricional" id="Diagnostico_nutri"></textarea>
              </div>
        </div><br>
		</div><br>
		<div style="border: ridge #0f0fef 1px;">
            <div class="form-row" style="margin: 10px;">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="plan_seguir" rows="2" required="" placeholder="Plan a seguir" id="plan_seguir"></textarea>
                </div>
            </div>
        </div><br>
		<div style="border: ridge #0f0fef 1px;">
