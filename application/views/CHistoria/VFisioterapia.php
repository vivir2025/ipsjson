...
<div class="mx-auto" style="width: 1300px;">
    <h5 style="color: blue;">HISTORIA  CLINICA FISIOTERAPIA PRIMERA VEZ APERTURA PROGRAMA DE GESTION DEL RIESGO CARDIORENAL - <?= $detalles_cita[0]->citFecha ?></h5>
    ...
    <fieldset>
        ...
        <div style="margin: 10px;">
                ...
                <select name="Actitud" id="Actitud" required="" class="form-control input-sm">
                ...
                <select name="Evaluaciond" id="Evaluaciond"required="" class="form-control input-sm">
                ...
                <select name="Evaluacionp" id="Evaluacionp"required="" class="form-control input-sm">
                    <option value="COLOR">COLOR</option>
                    <option value="ERIMATOSA">ERIMATOSA</option>
                    <option value="EQUIMOSIS">EQUIMOSIS</option>
                    </select>
                        </div>
                        <div class="form-group col-md-6">
                <strong>ESTADO</strong>
                <select name="Estado" id="Estado" required="" class="form-control input-sm">
                ...
                <textarea class="form-control input-sm" type="text" placeholder="Escribir" id="Evaluacion_dolor" name="Evaluacion_dolor"></textarea>
            </div>
           
            <div class="form-group col-md-6">
                <strong>EVALUACIÓN OSTEOARTICULAR</strong>
                <textarea class="form-control input-sm" type="text" placeholder="Escribir" id="Evaluacionos" name="Evaluacionos"></textarea>
            </div>
            <div class="form-group col-md-6">
                <strong>EVALUACIÓN NEUROMUSCULAR</strong>
                <textarea class="form-control input-sm" type="text" placeholder="Escribir" id="Evaluacionneu" name="Evaluacionneu"></textarea>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea  class="form-control input-sm" type="text" placeholder="Escribir" id="Comitante" name="Comitante"></textarea>
            </div>
