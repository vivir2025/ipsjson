<!-- List the home visits made by the auxiliaries through the app -->
<div class="container">
...
<script type='text/javascript'>
    function buscar_paciente2() {
        ...
        $.post("<?= base_url("index.php/CHistorial/buscar_paciente2") ?>", {
            documento: documento
        }, function(data) {
            $('#resultado').show();
            $("#resultado").html(data);
    ...
    function verVisitas(id_hcs_visitas, ) {

        
document.location.href = "<?php echo base_url(). 'index.php/CHistoria/Lista_Visita/' ?>"+  id_hcs_visitas;
