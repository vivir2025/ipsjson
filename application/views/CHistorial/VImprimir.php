...
<!-- Here the different medical records are printed since if it is a control first time nephro among the other histories -->
<div
class="bg-white">
<br>
            ...
            <fieldset>
                ...
                <div style="margin: 10px;">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <strong>2. DESCRIPCIÓN DEL PROBLEMA (DESCRIPCIÓN DEL PACIENTE DE LA SITUACIÓN QUE LO AFECTA)</strong>
                            <?php
                            echo $hap->hcPsicologiaDescripcionProblema; ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <strong>3. AVANCES DEL PACIENTE (CAMBIOS EN LA SITUACIÓN INICIAL POR LA CUAL SE ATENDIÓ EN PSICOLOGÍA)</strong>
                            <?php
                            echo $hap->hcAvancePaciente; ?>
                        </div>
                        <div class="form-group col-md-6">
                            <strong>4. PLAN DE INTERVENCIÓN Y RECOMENDACIONES</strong><br><br>
                            <?php
                            echo $hap->hcPsicologiaPlanIntervencionRecomendacion; ?>
                        </div>
                    </div>
