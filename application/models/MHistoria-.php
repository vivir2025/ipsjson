...
class MHistoria extends CI_Model
{
  ...
  public function guardar_visitas_excel($_DATOS_EXCEL1)
  {
    $resultado = $this
      ->db
      ->insert_batch('hcs_visitas', $_DATOS_EXCEL1);
  ...
  public function detalle_clasificacion($pacDocumento)
  {
    $consulta = $this->db->query("
      ...
      hc.hcAcuTelefono, hc.finalidad_idFinalidad,
      hc.hcClasificacionHta, hc.hcClasificacionDm, hc.hcClasificacionRcv, hc.hcAlimentacion, hc.hcHipertensionArterialPersonal, hc.hcDiabetesMellitusPersonal,
