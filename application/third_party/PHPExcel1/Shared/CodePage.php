 ...
 */
class PHPExcel1_Shared_CodePage
{
    /**
    ...
    public static function NumberToName($codePage = 1252)
    {
        switch ($codePage) {
            ...
            case 437:
                return 'CP437';    //    OEM US
            case 720:
                throw new PHPExcel1_Exception('Code page 720 not supported.');    //    OEM Arabic
            case 737:
            ...
            case 32768:
                return 'MAC';      //    Apple Roman
            case 32769:
                throw new PHPExcel1_Exception('Code page 32769 not supported.');  //    ANSI Latin I (BIFF2-BIFF3)
            case 65000:
                return 'UTF-7';    //    Unicode (UTF-7)
            case 65001:
                return 'UTF-8';    //    Unicode (UTF-8)
        }
        throw new PHPExcel1_Exception('Unknown codepage: ' . $codePage);
    }
}
