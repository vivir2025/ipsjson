...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
    define('PCLZIP_TEMPORARY_DIR', PHPExcel1_Shared_File::sys_get_temp_dir() . DIRECTORY_SEPARATOR);
}
require_once PHPExcel1_ROOT . 'PHPExcel1/Shared/PCLZip/pclzip.lib.php';

/**
 * PHPExcel1_Shared_ZipArchive
 *
...
class PHPExcel1_Shared_ZipArchive
{
    ...
    public function addFromString($localname, $contents)
    {
        ...
        if ($res == 0) {
            throw new PHPExcel1_Writer_Exception("Error zipping files : " . $this->zip->errorInfo(true));
        }
