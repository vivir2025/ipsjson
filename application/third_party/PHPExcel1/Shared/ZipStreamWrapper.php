...
/**
 * PHPExcel1_Shared_ZipStreamWrapper
 *
 ...
 */
class PHPExcel1_Shared_ZipStreamWrapper
{
    /**
     * Internal ZipAcrhive
     *
    ...
    public function stream_open($path, $mode, $options, &$opened_path)
    {
        // Check for mode
        if ($mode[0] != 'r') {
            throw new PHPExcel1_Reader_Exception('Mode ' . $mode . ' is not supported. Only read mode is supported.');
        }
