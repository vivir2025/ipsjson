...
class PHPExcel1_Shared_String
{
    ...
    public static function convertToNumberIfFraction(&$operand)
    {
        if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
            ...
            $operand = PHPExcel1_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
            return true;
        }
        return false;
    ...
    /**
     * Set the decimal separator. Only used by PHPExcel1_Style_NumberFormat::toFormattedString()
     * to format output by PHPExcel1_Writer_HTML and PHPExcel1_Writer_PDF
     *
    ...
    /**
     * Set the thousands separator. Only used by PHPExcel1_Style_NumberFormat::toFormattedString()
     * to format output by PHPExcel1_Writer_HTML and PHPExcel1_Writer_PDF
     *
    ...
    /**
     * Set the currency code. Only used by PHPExcel1_Style_NumberFormat::toFormattedString()
     *        to format output by PHPExcel1_Writer_HTML and PHPExcel1_Writer_PDF
     *
