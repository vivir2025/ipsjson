 ...
 */
class PHPExcel1_Reader_Excel5_MD5
{
    // Context
    private $a;
    private $b;
    ...
    public function add($data)
    {
        ...
        $F = array('PHPExcel1_Reader_Excel5_MD5','f');
        $G = array('PHPExcel1_Reader_Excel5_MD5','g');
        $H = array('PHPExcel1_Reader_Excel5_MD5','h');
        $I = array('PHPExcel1_Reader_Excel5_MD5','i');
