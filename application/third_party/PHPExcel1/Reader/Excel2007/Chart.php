 ...
 *
 * @category    PHPExcel1
 * @package        PHPExcel1_Reader_Excel2007
...
/**
 * PHPExcel1_Reader_Excel2007_Chart
 *
 * @category    PHPExcel1
 * @package        PHPExcel1_Reader_Excel2007
 * @copyright    Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 */
class PHPExcel1_Reader_Excel2007_Chart
{
                        ...
                        switch ($chartDetailsKey) {
                            case "plotArea":
                                ...
                                if ($plotAreaLayout == null) {
                                    $plotAreaLayout = new PHPExcel1_Chart_Layout();
                                }
                                $plotArea = new PHPExcel1_Chart_PlotArea($plotAreaLayout, $plotSeries);
                            ...
                            case "legend":
                                ...
                                $legend = new PHPExcel1_Chart_Legend($legendPos, $legendLayout, $legendOverlay);
                                break;
                        }
                    }
            }
        }
        $chart = new PHPExcel1_Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
    ...
    private static function chartTitle($titleDetails, $namespacesChartMeta, $type)
    {
        ...
        return new PHPExcel1_Chart_Title($caption, $titleLayout);
    }
...
//            echo $detailKey, ' => ',self::getAttribute($detail, 'val', 'string'),PHP_EOL;
        ...
        return new PHPExcel1_Chart_Layout($layout);
    }
    ...
    private static function chartDataSeries($chartDetail, $namespacesChartMeta, $plotType)
    {
        ...
        return new PHPExcel1_Chart_DataSeries($plotType, $multiSeriesType, $plotOrder, $seriesLabel, $seriesCategory, $seriesValues, $smoothLine);
    }
    ...
    private static function chartDataSeriesValueSet($seriesDetail, $namespacesChartMeta, $marker = null, $smoothLine = false)
    {
        if (isset($seriesDetail->strRef)) {
            ...
            return new PHPExcel1_Chart_DataSeriesValues('String', $seriesSource, $seriesData['formatCode'], $seriesData['pointCount'], $seriesData['dataValues'], $marker, $smoothLine);
        } elseif (isset($seriesDetail->numRef)) {
            $seriesSource = (string) $seriesDetail->numRef->f;
            $seriesData = self::chartDataSeriesValues($seriesDetail->numRef->numCache->children($namespacesChartMeta['c']));

            return new PHPExcel1_Chart_DataSeriesValues('Number', $seriesSource, $seriesData['formatCode'], $seriesData['pointCount'], $seriesData['dataValues'], $marker, $smoothLine);
        ...
        foreach ($titleDetailPart as $titleDetailElementKey => $titleDetailElement) {
            ...
            if (isset($titleDetailElement->rPr)) {
                ...
                if (!is_null($fontColor)) {
                    $objText->getFont()->setColor(new PHPExcel1_Style_Color(self::readColor($fontColor)));
                }
                ...
                if (!is_null($underscore)) {
                    if ($underscore == 'sng') {
                        ...
                        $objText->getFont()->setUnderline(PHPExcel1_Style_Font::UNDERLINE_DOUBLE);
                    } else {
                        $objText->getFont()->setUnderline(PHPExcel1_Style_Font::UNDERLINE_NONE);
                    }
                }
