...
/**
 * PHPExcel1_CachedObjectStorageFactory
 *
...
class PHPExcel1_CachedObjectStorageFactory
{
     ...
     *
     * @return PHPExcel1_CachedObjectStorage_ICache|null
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach (self::$storageMethods as $storageMethod) {
            $cacheStorageClass = 'PHPExcel1_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'PHPExcel1_CachedObjectStorage_'.$method;
        ...
        if (self::$cacheStorageMethod === null) {
            self::$cacheStorageClass = 'PHPExcel1_CachedObjectStorage_' . $method;
     ...
     *
     * @param    PHPExcel1_Worksheet     $parent        Enable cell caching for this worksheet
     * @return    PHPExcel1_CachedObjectStorage_ICache
     **/
    public static function getInstance(PHPExcel1_Worksheet $parent)
    {
