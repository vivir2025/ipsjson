...
/**
 * PHPExcel1_Chart_DataSeries
 *
 * @category    PHPExcel1
 * @package        PHPExcel1_Chart
 * @copyright    Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 */
class PHPExcel1_Chart_DataSeries
{
     ...
     * Plot Label
     *
     * @var array of PHPExcel1_Chart_DataSeriesValues
     */
    ...
    /**
     * Create a new PHPExcel1_Chart_DataSeries
     */
    public function __construct($plotType = null, $plotGrouping = null, $plotOrder = array(), $plotLabel = array(), $plotCategory = array(), $plotValues = array(), $plotDirection = null, $smoothLine = null, $plotStyle = null)
    {
        ...
        if ((count($plotLabel) == 0) || (is_null($plotLabel[$keys[0]]))) {
            $plotLabel[$keys[0]] = new PHPExcel1_Chart_DataSeriesValues();
        }

        $this->plotLabel = $plotLabel;
        if ((count($plotCategory) == 0) || (is_null($plotCategory[$keys[0]]))) {
            $plotCategory[$keys[0]] = new PHPExcel1_Chart_DataSeriesValues();
        }
     ...
     * Get Plot Labels
     *
     * @return array of PHPExcel1_Chart_DataSeriesValues
     */
