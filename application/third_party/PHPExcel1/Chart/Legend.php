...
class PHPExcel1_Chart_Legend
{
    ...
    /**
     *    Create a new PHPExcel1_Chart_Legend
     */
    public function __construct($position = self::POSITION_RIGHT, PHPExcel1_Chart_Layout $layout = null, $overlay = false)
    {
