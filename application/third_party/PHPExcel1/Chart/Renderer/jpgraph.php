...
require_once(PHPExcel1_Settings::getChartRendererPath().'/jpgraph.php');

/**
 * PHPExcel1_Chart_Renderer_jpgraph
 *
...
class PHPExcel1_Chart_Renderer_jpgraph
{
    ...
    private function formatDataSetLabels($groupID, $datasetLabels, $labelCount, $rotation = '')
    {
        ...
        foreach ($datasetLabels as $i => $datasetLabel) {
            if (is_array($datasetLabel)) {
                ...
                if (!is_null($datasetLabelFormatCode)) {
                    $datasetLabels[$i] = PHPExcel1_Style_NumberFormat::toFormattedString($datasetLabel, $datasetLabelFormatCode);
                }
            }
            ++$testCurrentIndex;
        }
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_line.php');
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_bar.php');
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_scatter.php');
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_regstat.php');
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_line.php');
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_pie.php');
        if ($dimensions == '3d') {
            require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_pie3d.php');
        }
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_radar.php');
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_stock.php');
    ...
    {
        require_once(PHPExcel1_Settings::getChartRendererPath().'jpgraph_contour.php');
    ...
    /**
     * Create a new PHPExcel1_Chart_Renderer_jpgraph
     */
    public function __construct(PHPExcel1_Chart $chart)
    {
        $this->graph    = null;
        $this->chart    = $chart;
    }
