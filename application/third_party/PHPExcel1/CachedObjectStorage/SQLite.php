...
/**
 * PHPExcel11_CachedObjectStorage_SQLite
 *
 ...
 */
class PHPExcel11_CachedObjectStorage_SQLite extends PHPExcel11_CachedObjectStorage_CacheBase implements PHPExcel11_CachedObjectStorage_ICache
{
    /**
     * Database table name
     *
    ...
    protected function storeData()
    {
        if ($this->currentCellIsDirty && !empty($this->currentObjectID)) {
            ...
            if (!$this->DBHandle->queryExec("INSERT OR REPLACE INTO kvp_".$this->TableName." VALUES('".$this->currentObjectID."','".sqlite_escape_string(serialize($this->currentObject))."')")) {
                throw new PHPExcel11_Exception(sqlite_error_string($this->DBHandle->lastError()));
            }
    ...
    public function moveCell($fromAddress, $toAddress)
    {
        ...
        if ($result === false) {
            throw new PHPExcel11_Exception($this->DBHandle->lastErrorMsg());
        }
