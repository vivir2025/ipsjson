...
/**
 * PHPExcel11_CachedObjectStorage_CacheBase
 *
 ...
 */
abstract class PHPExcel11_CachedObjectStorage_CacheBase
{
    /**
     * Parent worksheet
     *
     * @var PHPExcel11_Worksheet
     */
    protected $parent;
     ...
     */
    public function __construct(PHPExcel11_Worksheet $parent)
    {
        //    Set our parent worksheet.
        //    This is maintained within the cache controller to facilitate re-attaching it to PHPExcel11_Cell objects when
    ...
    public function getHighestColumn($row = null)
    {
        ...
        foreach ($this->getCellList() as $coord) {
            ...
            $columnList[] = PHPExcel11_Cell::columnIndexFromString($c);
        }
        return PHPExcel11_Cell::stringFromColumnIndex(max($columnList) - 1);
    }
