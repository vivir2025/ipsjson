...
/**
 * PHPExcel11_CachedObjectStorage_DiscISAM
 *
 ...
 */
class PHPExcel11_CachedObjectStorage_DiscISAM extends PHPExcel11_CachedObjectStorage_CacheBase implements PHPExcel11_CachedObjectStorage_ICache
{
    /**
    ...
    public function copyCellCollection(PHPExcel11_Worksheet $parent)
    {
        ...
        $newFileName = $this->cacheDirectory.'/PHPExcel11.'.$baseUnique.'.cache';
    ...
    public function __construct(PHPExcel11_Worksheet $parent, $arguments)
    {
        $this->cacheDirectory    = ((isset($arguments['dir'])) && ($arguments['dir'] !== null))
                                    ? $arguments['dir']
                                    : PHPExcel11_Shared_File::sys_get_temp_dir();

        parent::__construct($parent);
        if (is_null($this->fileHandle)) {
            $baseUnique = $this->getUniqueID();
            $this->fileName = $this->cacheDirectory.'/PHPExcel11.'.$baseUnique.'.cache';
            $this->fileHandle = fopen($this->fileName, 'a+');
        }
    }
