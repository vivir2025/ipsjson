...
class PHPExcel1_Helper_HTML
{
    ...
    public function toRichTextObject($html)
    {
        ...
        $this->richTextObject = new PHPExcel1_RichText();;
    ...
    protected function buildTextRun()
    {
        ...
        if ($this->color) {
            $richtextRun->getFont()->setColor(new PHPExcel1_Style_Color('ff' . $this->color));
        }
        if ($this->bold) {
        ...
        if ($this->underline) {
            $richtextRun->getFont()->setUnderline(PHPExcel1_Style_Font::UNDERLINE_SINGLE);
        }
        if ($this->superscript) {
