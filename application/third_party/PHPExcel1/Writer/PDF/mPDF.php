...
$pdfRendererClassFile = PHPExcel1_Settings::getPdfRendererPath() . '/mpdf.php';
 ...
 */
class PHPExcel1_Writer_PDF_mPDF extends PHPExcel1_Writer_PDF_Core implements PHPExcel1_Writer_IWriter
{
    /**
