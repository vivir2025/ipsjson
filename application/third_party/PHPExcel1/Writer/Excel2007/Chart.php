...
/**
 * PHPExcel1_Writer_Excel2007_Chart
 *
 ...
 */
class PHPExcel1_Writer_Excel2007_Chart extends PHPExcel1_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeChart(PHPExcel1_Chart $pChart = null, $calculateCellValues = true)
    {
     ...
     * Write Chart Title
     *
     * @param  PHPExcel1_Chart_Title $title
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeTitle(PHPExcel1_Chart_Title $title = null, $objWriter)
    {
        if (is_null($title)) {
            return;
        }
     ...
     * Write Chart Legend
     *
     * @param  PHPExcel1_Chart_Legend $legend
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeLegend(PHPExcel1_Chart_Legend $legend = null, $objWriter)
    {
        if (is_null($legend)) {
            return;
        }
     ...
     *
     * @param  PHPExcel1_Chart_PlotArea $plotArea
     * @param  PHPExcel1_Chart_Title $xAxisLabel
     * @param  PHPExcel1_Chart_Title $yAxisLabel
     * @param  PHPExcel1_Chart_Axis $xAxis
     * @param  PHPExcel1_Chart_Axis $yAxis
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writePlotArea(PHPExcel1_Chart_PlotArea $plotArea, PHPExcel1_Chart_Title $xAxisLabel = null, PHPExcel1_Chart_Title $yAxisLabel = null, $objWriter, PHPExcel1_Worksheet $pSheet, PHPExcel1_Chart_Axis $xAxis, PHPExcel1_Chart_Axis $yAxis, PHPExcel1_Chart_GridLines $majorGridlines, PHPExcel1_Chart_GridLines $minorGridlines)
    {
        if (is_null($plotArea)) {
            return;
        }
        ...
        foreach ($chartTypes as $chartType) {
            ...
            for ($i = 0; $i < $groupCount; ++$i) {
                ...
                if ($groupType == $chartType) {
                    ...
                    if ($groupType === PHPExcel1_Chart_DataSeries::TYPE_RADARCHART) {
                        $objWriter->startElement('c:radarStyle');
                        $objWriter->writeAttribute('val', $plotStyle);
                        $objWriter->endElement();
                    } elseif ($groupType === PHPExcel1_Chart_DataSeries::TYPE_SCATTERCHART) {
            ...
            if ($chartType === PHPExcel1_Chart_DataSeries::TYPE_LINECHART) {
                //    Line only, Line3D can't be smoothed

                $objWriter->startElement('c:smooth');
                $objWriter->writeAttribute('val', (integer) $plotGroup->getSmoothLine());
                $objWriter->endElement();
            } elseif (($chartType === PHPExcel1_Chart_DataSeries::TYPE_BARCHART) ||($chartType === PHPExcel1_Chart_DataSeries::TYPE_BARCHART_3D)) {
            ...
            } elseif ($chartType === PHPExcel1_Chart_DataSeries::TYPE_BUBBLECHART) {
                ...
                $objWriter->writeAttribute('val', 0);
                $objWriter->endElement();
            } elseif ($chartType === PHPExcel1_Chart_DataSeries::TYPE_STOCKCHART) {
            ...
            if (($chartType !== PHPExcel1_Chart_DataSeries::TYPE_PIECHART) && ($chartType !== PHPExcel1_Chart_DataSeries::TYPE_PIECHART_3D) && ($chartType !== PHPExcel1_Chart_DataSeries::TYPE_DONUTCHART)) {
                ...
                if ($chartType === PHPExcel1_Chart_DataSeries::TYPE_DONUTCHART) {
        ...
        if (($chartType !== PHPExcel1_Chart_DataSeries::TYPE_PIECHART) && ($chartType !== PHPExcel1_Chart_DataSeries::TYPE_PIECHART_3D) && ($chartType !== PHPExcel1_Chart_DataSeries::TYPE_DONUTCHART)) {
            if ($chartType === PHPExcel1_Chart_DataSeries::TYPE_BUBBLECHART) {
     ...
     *
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     * @param  PHPExcel1_Chart_Layout $chartLayout Chart layout
     *
     * @throws  PHPExcel1_Writer_Exception
     */
     ...
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeCategoryAxis($objWriter, PHPExcel1_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis)
    {
        ...
        if (!is_null($xAxisLabel)) {
            ...
            $objWriter->writeRawData(PHPExcel1_Shared_String::ControlCharacterPHP2OOXML($caption));
            $objWriter->endElement();
     ...
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeValueAxis($objWriter, PHPExcel1_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
    {
        ...
        if (!is_null($yAxisLabel)) {
            ...
            if ($groupType !== PHPExcel1_Chart_DataSeries::TYPE_BUBBLECHART) {
    ...
    private static function getChartType($plotArea)
    {
        ...
        if ($groupCount == 1) {
            ...
            if (count($chartTypes) == 0) {
                throw new PHPExcel1_Writer_Exception('Chart is not yet implemented');
            }
        }
     ...
     *
     * @param  PHPExcel1_Chart_DataSeries $plotGroup
     ...
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, PHPExcel1_Worksheet $pSheet)
    {
        if (is_null($plotGroup)) {
            return;
        }

        if (($groupType == PHPExcel1_Chart_DataSeries::TYPE_BARCHART) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_BARCHART_3D)) {
        ...
        if (($groupType !== PHPExcel1_Chart_DataSeries::TYPE_RADARCHART) && ($groupType !== PHPExcel1_Chart_DataSeries::TYPE_STOCKCHART)) {
            if ($groupType !== PHPExcel1_Chart_DataSeries::TYPE_LINECHART) {
                if (($groupType == PHPExcel1_Chart_DataSeries::TYPE_PIECHART) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_PIECHART_3D) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_DONUTCHART) || ($plotSeriesCount > 1)) {
        ...
        foreach ($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef) {
            ...
            if (($groupType == PHPExcel1_Chart_DataSeries::TYPE_PIECHART) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_PIECHART_3D) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_DONUTCHART)) {
            ...
            if (($groupType == PHPExcel1_Chart_DataSeries::TYPE_LINECHART) || ($groupType == PHPExcel1_Chart_DataSeries::TYPE_STOCKCHART)) {
                $objWriter->startElement('c:spPr');
                $objWriter->startElement('a:ln');
                $objWriter->writeAttribute('w', 12700);
                if ($groupType == PHPExcel1_Chart_DataSeries::TYPE_STOCKCHART) {
            ...
            if (($groupType === PHPExcel1_Chart_DataSeries::TYPE_BARCHART) || ($groupType === PHPExcel1_Chart_DataSeries::TYPE_BARCHART_3D) || ($groupType === PHPExcel1_Chart_DataSeries::TYPE_BUBBLECHART)) {
            ...
            if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0)) {
                ...
                if (($groupType === PHPExcel1_Chart_DataSeries::TYPE_BUBBLECHART) || ($groupType === PHPExcel1_Chart_DataSeries::TYPE_SCATTERCHART)) {
     ...
     *
     * @param  PHPExcel1_Chart_DataSeriesValues $plotSeriesLabel
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExcel1_Writer_Exception
     */
     ...
     *
     * @param  PHPExcel1_Chart_DataSeriesValues $plotSeriesValues
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     * @param  string $groupType Type of plot for dataseries
     ...
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', PHPExcel1_Worksheet $pSheet)
    {
     ...
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeBubbles($plotSeriesValues, $objWriter, PHPExcel1_Worksheet $pSheet)
    {
        if (is_null($plotSeriesValues)) {
            return;
        }
     ...
     * Write Layout
     *
     * @param  PHPExcel1_Chart_Layout $layout
     * @param  PHPExcel1_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExcel1_Writer_Exception
     */
    private function writeLayout(PHPExcel1_Chart_Layout $layout = null, $objWriter)
    {
