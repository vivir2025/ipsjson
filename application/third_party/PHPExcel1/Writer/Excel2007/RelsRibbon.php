...
/**
 * PHPExcel1_Writer_Excel2007_RelsRibbon
 *
 ...
 */
class PHPExcel1_Writer_Excel2007_RelsRibbon extends PHPExcel1_Writer_Excel2007_WriterPart
{
    /**
     ...
     */
    public function writeRibbonRelationships(PHPExcel1 $pPHPExcel1 = null)
    {
        // Create XML writer
        $objWriter = null;
        ...
        $localRels = $pPHPExcel1->getRibbonBinObjects('names');
