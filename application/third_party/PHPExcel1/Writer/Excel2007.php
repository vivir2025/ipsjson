 ...
 */
class PHPExcel1_Writer_Excel2007 extends PHPExcel1_Writer_Abstract implements PHPExcel1_Writer_IWriter
{
    /**
     * Pre-calculate formulas
     * Forces PHPExcel1 to recalculate all formulae in a workbook when saving, so that the pre-calculated values are
     ...
     *
     * @var PHPExcel1_Writer_Excel2007_WriterPart[]
     */
    ...
    /**
     * Private unique PHPExcel1_Style_Conditional HashTable
     *
     * @var PHPExcel1_HashTable
     */
    private $stylesConditionalHashTable;

    /**
     * Private unique PHPExcel1_Style HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Private unique PHPExcel1_Style_Fill HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Private unique PHPExcel1_Style_Font HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Private unique PHPExcel1_Style_Borders HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Private unique PHPExcel1_Style_NumberFormat HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Private unique PHPExcel1_Worksheet_BaseDrawing HashTable
     *
     * @var PHPExcel1_HashTable
     */
    ...
    /**
     * Create a new PHPExcel1_Writer_Excel2007
     *
     * @param     PHPExcel1    $pPHPExcel1
     */
    public function __construct(PHPExcel1 $pPHPExcel1 = null)
    {
        // Assign PHPExcel1
        $this->setPHPExcel1($pPHPExcel1);

        $writerPartsArray = array(  'stringtable'       => 'PHPExcel1_Writer_Excel2007_StringTable',
                                    'contenttypes'      => 'PHPExcel1_Writer_Excel2007_ContentTypes',
                                    'docprops'          => 'PHPExcel1_Writer_Excel2007_DocProps',
                                    'rels'              => 'PHPExcel1_Writer_Excel2007_Rels',
                                    'theme'             => 'PHPExcel1_Writer_Excel2007_Theme',
                                    'style'             => 'PHPExcel1_Writer_Excel2007_Style',
                                    'workbook'          => 'PHPExcel1_Writer_Excel2007_Workbook',
                                    'worksheet'         => 'PHPExcel1_Writer_Excel2007_Worksheet',
                                    'drawing'           => 'PHPExcel1_Writer_Excel2007_Drawing',
                                    'comments'          => 'PHPExcel1_Writer_Excel2007_Comments',
                                    'chart'             => 'PHPExcel1_Writer_Excel2007_Chart',
                                    'relsvba'           => 'PHPExcel1_Writer_Excel2007_RelsVBA',
                                    'relsribbonobjects' => 'PHPExcel1_Writer_Excel2007_RelsRibbon'
                                 );
        ...
        foreach ($hashTablesArray as $tableName) {
            $this->$tableName     = new PHPExcel1_HashTable();
        }
    }
     ...
     * @return     PHPExcel1_Writer_Excel2007_WriterPart
     */
    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            if (strtolower($pFilename) == 'php://output' || strtolower($pFilename) == 'php://stdout') {
                $pFilename = @tempnam(PHPExcel1_Shared_File::sys_get_temp_dir(), 'phpxltmp');
                if ($pFilename == '') {
                    $pFilename = $originalFilename;
                }
            }

            $saveDebugLog = PHPExcel1_Calculation::getInstance($this->spreadSheet)->getDebugLog()->getWriteDebugLog();
            PHPExcel1_Calculation::getInstance($this->spreadSheet)->getDebugLog()->setWriteDebugLog(false);
            ...
            if ($objZip->open($pFilename, $zipOverWrite) !== true) {
                if ($objZip->open($pFilename, $zipCreate) !== true) {
                    throw new PHPExcel1_Writer_Exception("Could not open " . $pFilename . " for writing.");
                }
            }
            ...
            for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
                if ($this->getDrawingHashTable()->getByIndex($i) instanceof PHPExcel1_Worksheet_Drawing) {
                    $imageContents = null;
                ...
                } elseif ($this->getDrawingHashTable()->getByIndex($i) instanceof PHPExcel1_Worksheet_MemoryDrawing) {
                    ob_start();
                    call_user_func(
            ...
            PHPExcel1_Calculation::getInstance($this->spreadSheet)->getDebugLog()->setWriteDebugLog($saveDebugLog);

            // Close file
            if ($objZip->close() === false) {
                throw new PHPExcel1_Writer_Exception("Could not close zip file $pFilename.");
            }

            // If a temporary file was used, copy it to the correct file stream
            if ($originalFilename != $pFilename) {
                if (copy($pFilename, $originalFilename) === false) {
                    throw new PHPExcel1_Writer_Exception("Could not copy temporary zip file $pFilename to $originalFilename.");
                }
                @unlink($pFilename);
            }
        } else {
            throw new PHPExcel1_Writer_Exception("PHPExcel1 object unassigned.");
        }
    }

    /**
     * Get PHPExcel1 object
     *
     * @return PHPExcel1
     * @throws PHPExcel1_Writer_Exception
     */
    public function getPHPExcel1()
    {
        if ($this->spreadSheet !== null) {
            return $this->spreadSheet;
        } else {
            throw new PHPExcel1_Writer_Exception("No PHPExcel1 object assigned.");
        }
    }

    /**
     * Set PHPExcel1 object
     *
     * @param     PHPExcel1     $pPHPExcel1    PHPExcel1 object
     * @throws    PHPExcel1_Writer_Exception
     * @return PHPExcel1_Writer_Excel2007
     */
    public function setPHPExcel1(PHPExcel1 $pPHPExcel1 = null)
    {
        $this->spreadSheet = $pPHPExcel1;
        return $this;
    }
    ...
    /**
     * Get PHPExcel1_Style HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Style_Conditional HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Style_Fill HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Style_Font HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Style_Borders HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Style_NumberFormat HashTable
     *
     * @return PHPExcel1_HashTable
     */
    ...
    /**
     * Get PHPExcel1_Worksheet_BaseDrawing HashTable
     *
     * @return PHPExcel1_HashTable
     */
