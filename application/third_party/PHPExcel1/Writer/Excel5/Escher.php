...
/**
 * PHPExcel1_Shared_Escher_DggContainer_BstoreContainer
 *
 * @category   PHPExcel1
 * @package    PHPExcel1_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 */
class PHPExcel1_Writer_Excel5_Escher
{
    /**
    ...
    public function close()
    {
        ...
        switch (get_class($this->object)) {
            case 'PHPExcel1_Shared_Escher':
                if ($dggContainer = $this->object->getDggContainer()) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($dggContainer);
                    $this->data = $writer->close();
                } elseif ($dgContainer = $this->object->getDgContainer()) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($dgContainer);
                    $this->data = $writer->close();
                    $this->spOffsets = $writer->getSpOffsets();
                    $this->spTypes = $writer->getSpTypes();
                }
                break;
            case 'PHPExcel1_Shared_Escher_DggContainer':
                ...
                if ($bstoreContainer = $this->object->getBstoreContainer()) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($bstoreContainer);
                ...
                break;
            case 'PHPExcel1_Shared_Escher_DggContainer_BstoreContainer':
                // this is a container record
                ...
                if ($BSECollection = $this->object->getBSECollection()) {
                    foreach ($BSECollection as $BSE) {
                        $writer = new PHPExcel1_Writer_Excel5_Escher($BSE);
                        $innerData .= $writer->close();
                    }
                }
                ...
                $this->data = $header . $innerData;
                break;
            case 'PHPExcel1_Shared_Escher_DggContainer_BstoreContainer_BSE':
                ...
                if ($blip = $this->object->getBlip()) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($blip);
                    $innerData .= $writer->close();
                }
                ...
                $this->data .= $data;
                break;
            case 'PHPExcel1_Shared_Escher_DggContainer_BstoreContainer_BSE_Blip':
                ...
                break;
            case 'PHPExcel1_Shared_Escher_DgContainer':
                // this is a container record
                ...
                if ($spgrContainer = $this->object->getSpgrContainer()) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($spgrContainer);
                    $innerData .= $writer->close();
                ...
                $this->data = $header . $innerData;
                break;
            case 'PHPExcel1_Shared_Escher_DgContainer_SpgrContainer':
                // this is a container record
                ...
                foreach ($this->object->getChildren() as $spContainer) {
                    $writer = new PHPExcel1_Writer_Excel5_Escher($spContainer);
                    $spData = $writer->close();
                    $innerData .= $spData;
                ...
                $this->spTypes = $spTypes;
                break;
            case 'PHPExcel1_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                // initialize
                $data = '';
                ...
                if ($this->object->getStartCoordinates()) {
                    ...
                    // start coordinates
                    list($column, $row) = PHPExcel1_Cell::coordinateFromString($this->object->getStartCoordinates());
                    $c1 = PHPExcel1_Cell::columnIndexFromString($column) - 1;
                    $r1 = $row - 1;
                    ...
                    // end coordinates
                    list($column, $row) = PHPExcel1_Cell::coordinateFromString($this->object->getEndCoordinates());
                    $c2 = PHPExcel1_Cell::columnIndexFromString($column) - 1;
                    $r2 = $row - 1;
