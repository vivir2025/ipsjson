...
/**
 * PHPExcel1_Writer_Excel5_BIFFwriter
 *
...
// */
class PHPExcel1_Writer_Excel5_BIFFwriter
{
    /**
    ...
    public static function getByteOrder()
    {
        if (!isset(self::$byteOrder)) {
            ...
            if ($number == $teststr) {
                ...
                throw new PHPExcel1_Writer_Exception("Required floating point format not supported on this platform.");
            }
