...
// */
class PHPExcel1_Writer_Excel5_Xf
{
    /**
    ...
    */
     ...
     *
     * @access public
     * @param PHPExcel1_Style    The XF format
     */
    public function __construct(PHPExcel1_Style $style = null)
    {
    ...
    public function writeXf()
    {
        ...
        $diag_tl_to_rb = $diagonalDirection == PHPExcel1_Style_Borders::DIAGONAL_BOTH
                            || $diagonalDirection == PHPExcel1_Style_Borders::DIAGONAL_DOWN;
        $diag_tr_to_lb = $diagonalDirection == PHPExcel1_Style_Borders::DIAGONAL_BOTH
                            || $diagonalDirection == PHPExcel1_Style_Borders::DIAGONAL_UP;
    ...
    private static $mapBorderStyles = array(
        PHPExcel1_Style_Border::BORDER_NONE             => 0x00,
        PHPExcel1_Style_Border::BORDER_THIN             => 0x01,
        PHPExcel1_Style_Border::BORDER_MEDIUM           => 0x02,
        PHPExcel1_Style_Border::BORDER_DASHED           => 0x03,
        PHPExcel1_Style_Border::BORDER_DOTTED           => 0x04,
        PHPExcel1_Style_Border::BORDER_THICK            => 0x05,
        PHPExcel1_Style_Border::BORDER_DOUBLE           => 0x06,
        PHPExcel1_Style_Border::BORDER_HAIR             => 0x07,
        PHPExcel1_Style_Border::BORDER_MEDIUMDASHED     => 0x08,
        PHPExcel1_Style_Border::BORDER_DASHDOT          => 0x09,
        PHPExcel1_Style_Border::BORDER_MEDIUMDASHDOT    => 0x0A,
        PHPExcel1_Style_Border::BORDER_DASHDOTDOT       => 0x0B,
        PHPExcel1_Style_Border::BORDER_MEDIUMDASHDOTDOT => 0x0C,
        PHPExcel1_Style_Border::BORDER_SLANTDASHDOT     => 0x0D,
    );
    ...
    private static $mapFillTypes = array(
        PHPExcel1_Style_Fill::FILL_NONE                    => 0x00,
        PHPExcel1_Style_Fill::FILL_SOLID                   => 0x01,
        PHPExcel1_Style_Fill::FILL_PATTERN_MEDIUMGRAY      => 0x02,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKGRAY        => 0x03,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTGRAY       => 0x04,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKHORIZONTAL  => 0x05,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKVERTICAL    => 0x06,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKDOWN        => 0x07,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKUP          => 0x08,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKGRID        => 0x09,
        PHPExcel1_Style_Fill::FILL_PATTERN_DARKTRELLIS     => 0x0A,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL => 0x0B,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTVERTICAL   => 0x0C,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTDOWN       => 0x0D,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTUP         => 0x0E,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTGRID       => 0x0F,
        PHPExcel1_Style_Fill::FILL_PATTERN_LIGHTTRELLIS    => 0x10,
        PHPExcel1_Style_Fill::FILL_PATTERN_GRAY125         => 0x11,
        PHPExcel1_Style_Fill::FILL_PATTERN_GRAY0625        => 0x12,
        PHPExcel1_Style_Fill::FILL_GRADIENT_LINEAR         => 0x00,    // does not exist in BIFF8
        PHPExcel1_Style_Fill::FILL_GRADIENT_PATH           => 0x00,    // does not exist in BIFF8
    );
    ...
    private static $mapHAlignments = array(
        PHPExcel1_Style_Alignment::HORIZONTAL_GENERAL           => 0,
        PHPExcel1_Style_Alignment::HORIZONTAL_LEFT              => 1,
        PHPExcel1_Style_Alignment::HORIZONTAL_CENTER            => 2,
        PHPExcel1_Style_Alignment::HORIZONTAL_RIGHT             => 3,
        PHPExcel1_Style_Alignment::HORIZONTAL_FILL              => 4,
        PHPExcel1_Style_Alignment::HORIZONTAL_JUSTIFY           => 5,
        PHPExcel1_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS => 6,
    );
    ...
    private static $mapVAlignments = array(
        PHPExcel1_Style_Alignment::VERTICAL_TOP     => 0,
        PHPExcel1_Style_Alignment::VERTICAL_CENTER  => 1,
        PHPExcel1_Style_Alignment::VERTICAL_BOTTOM  => 2,
        PHPExcel1_Style_Alignment::VERTICAL_JUSTIFY => 3,
    );
    ...
    {
        switch ($locked) {
            case PHPExcel1_Style_Protection::PROTECTION_INHERIT:
                return 1;
            case PHPExcel1_Style_Protection::PROTECTION_PROTECTED:
                return 1;
            case PHPExcel1_Style_Protection::PROTECTION_UNPROTECTED:
                return 0;
            default:
                return 1;
        }
