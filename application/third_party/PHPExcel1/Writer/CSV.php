 ...
 *
 * @category   PHPExcel1
 * @package    PHPExcel1_Writer_CSV
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 * @license    http://www.gnu.org/licenses/old-licenses/lgpl-2.1.txt    LGPL
 * @version    ##VERSION##, ##DATE##
 */
class PHPExcel1_Writer_CSV extends PHPExcel1_Writer_Abstract implements PHPExcel1_Writer_IWriter
{
    /**
     * PHPExcel1 object
     *
    ...
    /**
     * Create a new PHPExcel1_Writer_CSV
     *
    ...
    {
        // Fetch sheet
        $sheet = $this->PHPExcel1->getSheet($this->sheetIndex);
    ...
    private function writeLine($pFileHandle = null, $pValues = null)
    {
        if (is_array($pValues)) {
            ...
            throw new PHPExcel1_Writer_Exception("Invalid data row passed to CSV writer.");
        }
    }
}
