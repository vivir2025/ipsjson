...
/**
 * PHPExcel1_Writer_OpenDocument_Content
 *
 * @category   PHPExcel1
 * @package    PHPExcel1_Writer_OpenDocument
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 ...
 */
class PHPExcel1_Writer_OpenDocument_Content extends PHPExcel1_Writer_OpenDocument_WriterPart
{
    ...
    {
        if (!$pPHPExcel1) {
            $pPHPExcel1 = $this->getParentWriter()->getPHPExcel1(); /* @var $pPHPExcel1 PHPExcel1 */
        }
     ...
     * Write sheets
     *
     * @param PHPExcel1_Shared_XMLWriter $objWriter
     */
    private function writeSheets(PHPExcel1_Shared_XMLWriter $objWriter)
    {
        $pPHPExcel1 = $this->getParentWriter()->getPHPExcel1(); /* @var $pPHPExcel1 PHPExcel1 */

        $sheet_count = $pPHPExcel1->getSheetCount();
        for ($i = 0; $i < $sheet_count; $i++) {
            //$this->getWriterPart('Worksheet')->writeWorksheet());
            $objWriter->startElement('table:table');
                $objWriter->writeAttribute('table:name', $pPHPExcel1->getSheet($i)->getTitle());
                $objWriter->writeElement('office:forms');
                $objWriter->startElement('table:table-column');
                    $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
                $objWriter->endElement();
                $this->writeRows($objWriter, $pPHPExcel1->getSheet($i));
            $objWriter->endElement();
        }
    }
     ...
     */
    private function writeRows(PHPExcel1_Shared_XMLWriter $objWriter, PHPExcel1_Worksheet $sheet)
    {
     ...
     *
     * @param PHPExcel1_Shared_XMLWriter $objWriter
     * @param PHPExcel1_Worksheet_Row $row
     * @throws PHPExcel1_Writer_Exception
     */
    private function writeCells(PHPExcel1_Shared_XMLWriter $objWriter, PHPExcel1_Worksheet_Row $row)
    {
        ...
        while ($cells->valid()) {
            ...
            switch ($cell->getDataType()) {
                ...
                case PHPExcel1_Cell_DataType::TYPE_ERROR:
                    throw new PHPExcel1_Writer_Exception('Writing of error not implemented yet.');
                    break;
                ...
                case PHPExcel1_Cell_DataType::TYPE_INLINE:
                    throw new PHPExcel1_Writer_Exception('Writing of inline not implemented yet.');
                    break;
            ...
            PHPExcel1_Writer_OpenDocument_Cell_Comment::write($objWriter, $cell);
            $objWriter->endElement();
            $prev_column = $column;
            $cells->next();
        }
     ...
     */
    private function writeCellSpan(PHPExcel1_Shared_XMLWriter $objWriter, $curColumn, $prevColumn)
    {
