...
/**
 * PHPExcel1_Writer_OpenDocument_Cell_Comment
 *
 * @category   PHPExcel1
 * @package    PHPExcel1_Writer_OpenDocument
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 ...
 */
class PHPExcel1_Writer_OpenDocument_Cell_Comment
{
    public static function write(PHPExcel1_Shared_XMLWriter $objWriter, PHPExcel1_Cell $cell)
    {
        ...
        $objWriter->startElement('office:annotation');
            ...
            //$objWriter->writeAttribute('draw:caption-point-y', $comment->getMarginTop());
                ...
                // TODO: Not realized in PHPExcel1_Comment yet.
