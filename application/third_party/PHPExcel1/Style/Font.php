 ...
 */
class PHPExcel1_Style_Font extends PHPExcel1_Style_Supervisor implements PHPExcel1_IComparable
{
    /* Underline types */
    ...
    /**
     * Create a new PHPExcel1_Style_Font
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        if ($isConditional) {
            ...
            $this->color = new PHPExcel1_Style_Color(PHPExcel1_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
        } else {
     ...
     *
     * <code>
     * $objPHPExcel1->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
     *        array(
     *            'name'        => 'Arial',
     *            'bold'        => TRUE,
     *            'italic'    => FALSE,
     ...
     * Set Underline
     *
     * @param string|boolean $pValue    PHPExcel1_Style_Font underline type
