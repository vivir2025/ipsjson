 ...
 */
class PHPExcel1_Style_Alignment extends PHPExcel1_Style_Supervisor implements PHPExcel1_IComparable
{
     ...
     * @var string
     */
    protected $horizontal = PHPExcel1_Style_Alignment::HORIZONTAL_GENERAL;
     ...
     * @var string
     */
    protected $vertical = PHPExcel1_Style_Alignment::VERTICAL_BOTTOM;
    ...
    /**
     * Create a new PHPExcel1_Style_Alignment
     *
     ...
     *
     * <code>
     * $objPHPExcel1->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
     *        array(
     *            'horizontal' => PHPExcel1_Style_Alignment::HORIZONTAL_CENTER,
     *            'vertical'   => PHPExcel1_Style_Alignment::VERTICAL_CENTER,
     *            'rotation'   => 0,
     *            'wrap'            => TRUE
     *        )
     * );
     ...
     * @return PHPExcel1_Style_Alignment
     */
    public function setHorizontal($pValue = PHPExcel1_Style_Alignment::HORIZONTAL_GENERAL)
    {
        if ($pValue == '') {
            $pValue = PHPExcel1_Style_Alignment::HORIZONTAL_GENERAL;
        }
     ...
     * @return PHPExcel1_Style_Alignment
     */
    public function setVertical($pValue = PHPExcel1_Style_Alignment::VERTICAL_BOTTOM)
    {
        if ($pValue == '') {
            $pValue = PHPExcel1_Style_Alignment::VERTICAL_BOTTOM;
        }
    ...
    {
        // Excel2007 value 255 => PHPExcel1 value -165
        if ($pValue == 255) {
            $pValue = -165;
        }
        ...
        if (($pValue >= -90 && $pValue <= 90) || $pValue == -165) {
            ...
            throw new PHPExcel1_Exception("Text rotation should be a value between -90 and 90.");
        }
