 ...
 */
class PHPExcel1_Style_NumberFormat extends PHPExcel1_Style_Supervisor implements PHPExcel1_IComparable
{
    /* Pre-defined formats */
     ...
     * @var string
     */
    protected $formatCode = PHPExcel1_Style_NumberFormat::FORMAT_GENERAL;
    ...
    /**
     * Create a new PHPExcel1_Style_NumberFormat
     *
     ...
     *
     * <code>
     * $objPHPExcel1->getActiveSheet()->getStyle('B2')->getNumberFormat()->applyFromArray(
     *        array(
     *            'code' => PHPExcel1_Style_NumberFormat::FORMAT_CURRENCY_EUR_SIMPLE
     *        )
     * );
     * </code>
     *
     ...
     * @return PHPExcel1_Style_NumberFormat
     */
    public function setFormatCode($pValue = PHPExcel1_Style_NumberFormat::FORMAT_GENERAL)
    {
        if ($pValue == '') {
            $pValue = PHPExcel1_Style_NumberFormat::FORMAT_GENERAL;
        }
        if ($this->isSupervisor) {
    ...
    private static function fillBuiltInFormatCodes()
    {
        ...
        if (is_null(self::$builtInFormats)) {
            ...
            // General
            self::$builtInFormats[0] = PHPExcel1_Style_NumberFormat::FORMAT_GENERAL;
    ...
    private static function formatAsDate(&$value, &$format)
    {
        ...
        $dateObj = PHPExcel1_Shared_Date::ExcelToPHPObject($value);
    ...
    private static function formatAsFraction(&$value, &$format)
    {
        ...
        $GCD = PHPExcel1_Calculation_MathTrig::GCD($decimalPart, $decimalDivisor);
     ...
     */
    public static function toFormattedString($value = '0', $format = PHPExcel1_Style_NumberFormat::FORMAT_GENERAL, $callBack = null)
    {
        ...
        if (($format === PHPExcel1_Style_NumberFormat::FORMAT_GENERAL) || ($format === PHPExcel1_Style_NumberFormat::FORMAT_TEXT)) {
            return $value;
        }
                    ...
                    if (preg_match($number_regex, $m, $matches)) {
                        ...
                        if ($useThousands) {
                            $value = number_format(
                                $value,
                                strlen($right),
                                PHPExcel1_Shared_String::getDecimalSeparator(),
