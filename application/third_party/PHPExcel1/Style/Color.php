 ...
 */
class PHPExcel1_Style_Color extends PHPExcel1_Style_Supervisor implements PHPExcel1_IComparable
{
    /* Colors */
    ...
    /**
     * Create a new PHPExcel1_Style_Color
     *
     ...
     *                                        its ramifications are
     */
    public function __construct($pARGB = PHPExcel1_Style_Color::COLOR_BLACK, $isSupervisor = false, $isConditional = false)
    {
        //    Supervisor?
     ...
     *
     * <code>
     * $objPHPExcel1->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
     * </code>
     *
     ...
     * @return PHPExcel1_Style_Color
     */
    public function setARGB($pValue = PHPExcel1_Style_Color::COLOR_BLACK)
    {
        if ($pValue == '') {
            $pValue = PHPExcel1_Style_Color::COLOR_BLACK;
        }
        if ($this->isSupervisor) {
    ...
    public static function indexedColor($pIndex, $background = false)
    {
        ...
        if (array_key_exists($pIndex, self::$indexedColors)) {
            return new PHPExcel1_Style_Color(self::$indexedColors[$pIndex]);
        }

        if ($background) {
            return new PHPExcel1_Style_Color(self::COLOR_WHITE);
        }
        return new PHPExcel1_Style_Color(self::COLOR_BLACK);
    }
