 ...
 */
class PHPExcel1_Style_Protection extends PHPExcel1_Style_Supervisor implements PHPExcel1_IComparable
{
    /** Protection styles */
    ...
    /**
     * Create a new PHPExcel1_Style_Protection
     *
     ...
     *
     * <code>
     * $objPHPExcel1->getActiveSheet()->getStyle('B2')->getLocked()->applyFromArray(
     *        array(
     *            'locked' => TRUE,
     *            'hidden' => FALSE
     *        )
