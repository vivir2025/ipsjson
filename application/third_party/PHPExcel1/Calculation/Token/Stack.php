...
/**
 * PHPExcel11_Calculation_Token_Stack
 *
...
class PHPExcel11_Calculation_Token_Stack
{
    ...
    public function push($type, $value, $reference = null)
    {
        ...
        if ($type == 'Function') {
            $localeFunction = PHPExcel11_Calculation::localeFunc($value);
