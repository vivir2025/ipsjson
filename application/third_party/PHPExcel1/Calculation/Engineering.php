...
/**
 * PHPExcel1_Calculation_Engineering
 *
 ...
 */
class PHPExcel1_Calculation_Engineering
{
    /**
    ...
    {
        $x    = (is_null($x))    ? 0.0 :    PHPExcel1_Calculation_Functions::flattenSingleValue($x);
        $ord    = (is_null($ord))    ? 0.0 :    PHPExcel1_Calculation_Functions::flattenSingleValue($ord);
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            if (abs($x) <= 30) {
                $fResult = $fTerm = pow($x / 2, $ord) / PHPExcel1_Calculation_MathTrig::FACT($ord);
                $ordK = 1;
                $fSqrX = ($x * $x) / 4;
                do {
                    $fTerm *= $fSqrX;
            ...
            return (is_nan($fResult)) ? PHPExcel1_Calculation_Functions::NaN() : $fResult;
        }
    ...
    public static function BESSELK($x, $ord)
    {
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            return (is_nan($fBk)) ? PHPExcel1_Calculation_Functions::NaN() : $fBk;
        }
        return PHPExcel1_Calculation_Functions::VALUE();
    }
    ...
    public static function BESSELY($x, $ord)
    {
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            return (is_nan($fBy)) ? PHPExcel1_Calculation_Functions::NaN() : $fBy;
        }
        return PHPExcel1_Calculation_Functions::VALUE();
    }
    ...
    {
        $x    = PHPExcel1_Calculation_Functions::flattenSingleValue($x);
        $places    = PHPExcel1_Calculation_Functions::flattenSingleValue($places);
    ...
    {
        $realNumber = (is_null($realNumber)) ? 0.0 : PHPExcel1_Calculation_Functions::flattenSingleValue($realNumber);
        $imaginary  = (is_null($imaginary))  ? 0.0 : PHPExcel1_Calculation_Functions::flattenSingleValue($imaginary);
        $suffix     = (is_null($suffix))     ? 'i' : PHPExcel1_Calculation_Functions::flattenSingleValue($suffix);
    ...
    {
        $complexNumber    = PHPExcel1_Calculation_Functions::flattenSingleValue($complexNumber);
    ...
    {
        $complexNumber = PHPExcel1_Calculation_Functions::flattenSingleValue($complexNumber);
        $realNumber    = PHPExcel1_Calculation_Functions::flattenSingleValue($realNumber);
    ...
    {
        $complexDividend    = PHPExcel1_Calculation_Functions::flattenSingleValue($complexDividend);
        $complexDivisor    = PHPExcel1_Calculation_Functions::flattenSingleValue($complexDivisor);
    ...
    {
        $complexNumber1    = PHPExcel1_Calculation_Functions::flattenSingleValue($complexNumber1);
        $complexNumber2    = PHPExcel1_Calculation_Functions::flattenSingleValue($complexNumber2);
    ...
    public static function GESTEP($number, $step = 0)
    {
        ...
        $step    = PHPExcel1_Calculation_Functions::flattenSingleValue($step);
     ...
     *            PHPExcel1 follows Excel 2010 behaviour, and accepts nagative arguments.
     *
     *    Excel Function:
     *        ERF(lower[,upper])
     *
    ...
    {
        $lower    = PHPExcel1_Calculation_Functions::flattenSingleValue($lower);
        $upper    = PHPExcel1_Calculation_Functions::flattenSingleValue($upper);
    ...
    public static function CONVERTUOM($value, $fromUOM, $toUOM)
    {
        ...
        $fromUOM = PHPExcel1_Calculation_Functions::flattenSingleValue($fromUOM);
        $toUOM   = PHPExcel1_Calculation_Functions::flattenSingleValue($toUOM);
