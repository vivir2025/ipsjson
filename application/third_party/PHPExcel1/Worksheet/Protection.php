...
/**
 * PHPExcel1_Worksheet_Protection
 *
 * @category   PHPExcel1
 * @package    PHPExcel1_Worksheet
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 */
class PHPExcel1_Worksheet_Protection
{
    /**
     * Sheet
     *
    ...
    /**
     * Create a new PHPExcel1_Worksheet_Protection
     */
    ...
    {
        if (!$pAlreadyHashed) {
            $pValue = PHPExcel1_Shared_PasswordHasher::hashPassword($pValue);
        }
