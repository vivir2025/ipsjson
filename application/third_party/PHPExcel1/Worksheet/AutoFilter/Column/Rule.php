...
/**
 * PHPExcel1_Worksheet_AutoFilter_Column_Rule
 *
 ...
 */
class PHPExcel1_Worksheet_AutoFilter_Column_Rule
{
...
//    const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER    = 'allDatesInQuarter';    //    <dynamicFilter type="Q2"/> for Quarter 2
     ...
     * Autofilter Column
     *
     * @var PHPExcel1_Worksheet_AutoFilter_Column
     */
    private $parent = null;
    ...
    /**
     * Create a new PHPExcel1_Worksheet_AutoFilter_Column_Rule
     *
     * @param PHPExcel1_Worksheet_AutoFilter_Column $pParent
     */
    public function __construct(PHPExcel1_Worksheet_AutoFilter_Column $pParent = null)
    {
        $this->parent = $pParent;
    }
    ...
    public function setRuleType($pRuleType = self::AUTOFILTER_RULETYPE_FILTER)
    {
        if (!in_array($pRuleType, self::$ruleTypes)) {
            throw new PHPExcel1_Exception('Invalid rule type for column AutoFilter Rule.');
        }
    ...
    public function setValue($pValue = '')
    {
        if (is_array($pValue)) {
            ...
            if (count($pValue) == 0) {
                throw new PHPExcel1_Exception('Invalid rule value for column AutoFilter Rule.');
            }
    ...
    public function setOperator($pOperator = self::AUTOFILTER_COLUMN_RULE_EQUAL)
    {
        ...
        if ((!in_array($pOperator, self::$operators)) &&
            ...
            throw new PHPExcel1_Exception('Invalid operator for column AutoFilter Rule.');
        }
     ...
     *
     * @param PHPExcel1_Worksheet_AutoFilter_Column
     * @return PHPExcel1_Worksheet_AutoFilter_Column_Rule
     */
    public function setParent(PHPExcel1_Worksheet_AutoFilter_Column $pParent = null)
    {
        $this->parent = $pParent;
