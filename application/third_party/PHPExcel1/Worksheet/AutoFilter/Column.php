...
/**
 * PHPExcel1_Worksheet_AutoFilter_Column
 *
 ...
 */
class PHPExcel1_Worksheet_AutoFilter_Column
{
     ...
     *
     * @var array of PHPExcel1_Worksheet_AutoFilter_Column_Rule
     */
    ...
    /**
     * Create a new PHPExcel1_Worksheet_AutoFilter_Column
     *
     *    @param    string                           $pColumn        Column (e.g. A)
     *    @param    PHPExcel1_Worksheet_AutoFilter  $pParent        Autofilter for this column
     */
    public function __construct($pColumn, PHPExcel1_Worksheet_AutoFilter $pParent = null)
    {
     ...
     *
     * @param PHPExcel1_Worksheet_AutoFilter
     * @return PHPExcel1_Worksheet_AutoFilter_Column
     */
    public function setParent(PHPExcel1_Worksheet_AutoFilter $pParent = null)
    {
        $this->parent = $pParent;
    ...
    public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER)
    {
        if (!in_array($pFilterType, self::$filterTypes)) {
            throw new PHPExcel1_Exception('Invalid filter type for column AutoFilter.');
        }
    ...
    public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR)
    {
        ...
        if (!in_array($pJoin, self::$ruleJoins)) {
            throw new PHPExcel1_Exception('Invalid rule connection for column AutoFilter.');
        }
     ...
     *
     * @throws    PHPExcel1_Exception
     * @return array of PHPExcel1_Worksheet_AutoFilter_Column_Rule
     */
     ...
     * @return    PHPExcel1_Worksheet_AutoFilter_Column_Rule
     */
    public function getRule($pIndex)
    {
        if (!isset($this->ruleset[$pIndex])) {
            $this->ruleset[$pIndex] = new PHPExcel1_Worksheet_AutoFilter_Column_Rule($this);
        }
    ...
    {
        $this->ruleset[] = new PHPExcel1_Worksheet_AutoFilter_Column_Rule($this);
     ...
     *
     * @param    PHPExcel1_Worksheet_AutoFilter_Column_Rule    $pRule
     * @param    boolean    $returnRule     Flag indicating whether the rule object or the column object should be returned
     * @return    PHPExcel1_Worksheet_AutoFilter_Column|PHPExcel1_Worksheet_AutoFilter_Column_Rule
     */
    public function addRule(PHPExcel1_Worksheet_AutoFilter_Column_Rule $pRule, $returnRule = true)
    {
