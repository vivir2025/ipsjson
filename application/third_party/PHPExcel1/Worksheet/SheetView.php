 ...
 */
class PHPExcel1_Worksheet_SheetView
{
    ...
    /**
     * Create a new PHPExcel1_Worksheet_SheetView
     */
    ...
    public function setZoomScale($pValue = 100)
    {
        ...
        if (($pValue >= 1) || is_null($pValue)) {
            ...
            throw new PHPExcel1_Exception("Scale must be greater than or equal to 1.");
        }
        return $this;
    }
    ...
    public function setView($pValue = null)
    {
        ...
        if (in_array($pValue, self::$sheetViewTypes)) {
            ...
            throw new PHPExcel1_Exception("Invalid sheetview layout type.");
        }
