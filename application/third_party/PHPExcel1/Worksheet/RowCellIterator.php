...
/**
 * PHPExcel1_Worksheet_RowCellIterator
 *
 ...
 */
class PHPExcel1_Worksheet_RowCellIterator extends PHPExcel1_Worksheet_CellIterator implements Iterator
{
    /**
     * Row index
     *
     ...
     */
    public function __construct(PHPExcel1_Worksheet $subject = null, $rowIndex = 1, $startColumn = 'A', $endColumn = null)
    {
     ...
     * @return PHPExcel1_Worksheet_RowCellIterator
    ...
    public function resetStart($startColumn = 'A')
    {
        ...
        $this->seek(PHPExcel1_Cell::stringFromColumnIndex($this->startColumn));
