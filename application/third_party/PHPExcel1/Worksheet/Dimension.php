 ...
 */
abstract class PHPExcel1_Worksheet_Dimension
{
    /**
     * Visible?
     *
    ...
    /**
     * Create a new PHPExcel1_Worksheet_Dimension
     *
     ...
     *
     * @param bool $pValue
     * @return PHPExcel1_Worksheet_Dimension
     */
    ...
    public function setOutlineLevel($pValue)
    {
        if ($pValue < 0 || $pValue > 7) {
            throw new PHPExcel1_Exception("Outline level must range between 0 and 7.");
        }
