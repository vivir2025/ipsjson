 ...
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel1 (http://www.codeplex.com/PHPExcel1)
 */
class PHPExcel1_Worksheet_PageSetup
{
    /* Paper size */
     ...
     * @var int
     */
    private $paperSize = PHPExcel1_Worksheet_PageSetup::PAPERSIZE_LETTER;
     ...
     * @var string
     */
    private $orientation = PHPExcel1_Worksheet_PageSetup::ORIENTATION_DEFAULT;
    ...
    /**
     * Create a new PHPExcel1_Worksheet_PageSetup
     */
    ...
    public function setScale($pValue = 100, $pUpdate = true)
    {
        ...
        if (($pValue >= 0) || is_null($pValue)) {
            ...
            throw new PHPExcel1_Exception("Scale must not be negative");
        }
        return $this;
    }
    ...
    public function getPrintArea($index = 0)
    {
        ...
        throw new PHPExcel1_Exception("Requested Print Area does not exist");
    }
    ...
    public function setPrintArea($value, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE)
    {
        if (strpos($value, '!') !== false) {
            throw new PHPExcel1_Exception('Cell coordinate must not specify a worksheet.');
        } elseif (strpos($value, ':') === false) {
            throw new PHPExcel1_Exception('Cell coordinate must be a range of cells.');
        } elseif (strpos($value, '$') !== false) {
        ...
        if ($method == self::SETPRINTRANGE_OVERWRITE) {
            if ($index == 0) {
                ...
                if (($index <= 0) || ($index > count($printAreas))) {
                    throw new PHPExcel1_Exception('Invalid index for setting print range.');
                }
            ...
            throw new PHPExcel1_Exception('Invalid method for setting print range.');
        }
    ...
    public function setPrintAreaByColumnAndRow($column1, $row1, $column2, $row2, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE)
    {
        return $this->setPrintArea(
            PHPExcel1_Cell::stringFromColumnIndex($column1) . $row1 . ':' . PHPExcel1_Cell::stringFromColumnIndex($column2) . $row2,
            $index,
            $method
        );
    }
