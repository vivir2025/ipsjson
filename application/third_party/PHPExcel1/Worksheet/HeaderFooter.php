<?php
/**
 * PHPExcel1_Worksheet_HeaderFooter
 *
 ...
 *
 */
class PHPExcel1_Worksheet_HeaderFooter
{
     ...
     *
     * @var PHPExcel1_Worksheet_HeaderFooterDrawing[]
     */
    private $headerFooterImages = array();

    /**
     * Create a new PHPExcel1_Worksheet_HeaderFooter
     */
     ...
     *
     * @param PHPExcel1_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws PHPExcel1_Exception
     * @return PHPExcel1_Worksheet_HeaderFooter
     */
    public function addImage(PHPExcel1_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT)
    {
     ...
     *
     * @param PHPExcel1_Worksheet_HeaderFooterDrawing[] $images
     * @throws PHPExcel1_Exception
     * @return PHPExcel1_Worksheet_HeaderFooter
     */
    ...
    {
        if (!is_array($images)) {
            throw new PHPExcel1_Exception('Invalid parameter!');
        }
     ...
     *
     * @return PHPExcel1_Worksheet_HeaderFooterDrawing[]
     */
