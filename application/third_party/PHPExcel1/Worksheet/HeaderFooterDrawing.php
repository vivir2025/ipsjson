...
/**
 * PHPExcel1_Worksheet_HeaderFooterDrawing
 *
 ...
 */
class PHPExcel1_Worksheet_HeaderFooterDrawing extends PHPExcel1_Worksheet_Drawing implements PHPExcel1_IComparable
{
    /**
     * Path
     *
    ...
    /**
     * Create a new PHPExcel1_Worksheet_HeaderFooterDrawing
     */
    ...
    public function setPath($pValue = '', $pVerifyFile = true)
    {
        if ($pVerifyFile) {
            if (file_exists($pValue)) {
                ...
                throw new PHPExcel1_Exception("File $pValue not found!");
            }
        } else {
            $this->path = $pValue;
        }
